...
import { WidgetItemsProps } from "./section-cards";
    ...
    >
      <div
        className={cn(
          ...
          showDataStatusTab ? "justify-between" : "justify-end"
        )}
      >
        ...
        <div className="flex items-end justify-items-end gap-2">
          {showCustomiseColumn && (
            <DropdownMenu>
          ...
          {tableRightNavigationComponent && tableRightNavigationComponent}
        </div>
      </div>
